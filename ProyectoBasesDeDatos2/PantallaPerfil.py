...
class PantallaPerfilEmpleado(CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        iconBack = iconoClickable(panelSuperior, "BackSymbol1", 51, 51, lambda: self.controller.show_frame(PantallaPrincipalEmpleado.MenuPrincipalUsuario))
...
class PantallaPerfilAspirante(CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        #Ícono para volver atrás
        iconBack = iconoClickable(panelSuperior, "BackSymbol1", 51, 51, lambda: self.controller.show_frame(PantallaPrincipalAspirante.MenuPrincipalUsuario))
        iconBack.pack(side = "left", padx = 20, pady = 10)
