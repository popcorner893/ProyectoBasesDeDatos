...
class GestionarUsuariosPrincipal(CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        botonAgregarEmpleado = botonAccion(panelAgregar, "Empleado", 25, "verde", 60, 34, lambda: self.controller.show_frame(AnadirUsuario))
        botonAgregarEmpleado.pack(side = "right", padx = 10)

        botonAgregarAspirante = botonAccion(panelAgregar, "Aspirante", 25, "verde", 60, 34, lambda: self.controller.show_frame(AnadirUsuario))
        ...
        botonModificarEmpleado = botonAccion(panelModificar, "Empleado", 25, "verde", 60, 34, lambda: self.controller.show_frame(ModificarUsuario))
        botonModificarEmpleado.pack(side = "right", padx = 10)

        botonModificarAspirante = botonAccion(panelModificar, "Aspirante", 25, "verde", 60, 34, lambda: self.controller.show_frame(ModificarUsuario))
        ...
        botonEliminarEmpleado = botonAccion(panelEliminar, "Empleado", 25, "verde", 60, 34, lambda: self.controller.show_frame(EliminarUsuario))
        botonEliminarEmpleado.pack(side = "right", padx = 10)

        botonEliminarAspirante = botonAccion(panelEliminar, "Aspirante", 25, "verde", 60, 34, lambda: self.controller.show_frame(EliminarUsuario))
