...
class RealizarEvaluacion(CTkFrame):
    def __init__(self, parent, controller):
        ...
        entrada1 = EntradaEvaluacion(panelScrollable,"nombre_cargo", "nombre_aspirante", "apellido1_aspirante", "apellido2_aspirante", "id_aspirante", self.controller)
...
class EvaluacionEnProceso(CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        #Ícono para volver atrás
        iconBack = CTkImage(dark_image= Image.open("BackSymbol1.png"), size = (51,51))
        img_lab1 = CTkButton(panelUsuario, image=iconBack, text="", bg_color="white", fg_color="white", width=51, height=51, hover_color = "white", command=lambda: self.controller.show_frame(RealizarEvaluacion))
        img_lab1.pack(side = "left", padx = 20, pady = 10)
        ...
        botonIrSesion = botonAccion(panelSesion, "Ir", 25, "verde", 60, 34, lambda: self.controller.show_frame(Cuestionarios.EvaluacionSesionDocente))
        ...
        botonIrPropuesta = botonAccion(panelPropuesta, "Ir", 25, "verde", 60, 34, lambda: self.controller.show_frame(Cuestionarios.EvaluacionPropuestaInvestigacion))
        ...
        botonIrHoja = botonAccion(panelHoja, "Ir", 25, "verde", 60, 34, lambda: self.controller.show_frame(Cuestionarios.EvaluacionHojaDeVidaGeneral))
        ...
        botonIrEntrevista = botonAccion(panelEntrevista, "Ir", 25, "verde", 60, 34, lambda: self.controller.show_frame(Cuestionarios.EvaluacionEntrevista))
...
class EntradaEvaluacion(CTkFrame):
    ...
    def __init__(self, parent, text1, text2, text3, text4, text5, controller):
        
        super().__init__(parent, fg_color="#DEEDFD", corner_radius=16) 

        infoAspirante = entradaLista(self,text1, text2, text3, text4, text5)
        infoAspirante.configure(fg_color = "transparent")
        infoAspirante.pack(anchor = "nw", pady = 10, expand = True, fill = "x")

        botonEvaluar = botonAccion(self,"Realizar Evaluación", 20, "verde", 300, 40, lambda: controller.show_frame(EvaluacionEnProceso))
